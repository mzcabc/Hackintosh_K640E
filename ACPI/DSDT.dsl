 ...
 *
 * Disassembly of iASLY5dOvQ.aml, Fri Sep  2 19:25:32 2016
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00011E8B (73355)
 *     Revision         0x02
 *     Checksum         0x3E
 *     OEM ID           "Apple "
 ...
 */
DefinitionBlock ("", "DSDT", 2, "Apple ", "PARADISE", 0x00000034)
{
    /*
    ...
    External (_SB_.PCI0.GFX0, UnknownObj)    // Warning: Unknown object
    ...
    External (_SB_.PCI0.GFX0.LCD0, UnknownObj)    // Warning: Unknown object
    ...
    External (_SB_.PCI0.PEG0.PEGP.NHDM, UnknownObj)    // Warning: Unknown object
    ...
    External (GFX0, UnknownObj)    // Warning: Unknown object
    External (GSMI, UnknownObj)    // Warning: Unknown object
    External (LIDS, IntObj)    // Warning: Unknown object
    External (MDBG, IntObj)    // Warning: Unknown object
    External (NVHA, UnknownObj)    // Warning: Unknown object
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xC97A8C18, 0x02C2)
    ...
    Method (_PTS, 1, NotSerialized)  // _PTS: Prepare To Sleep
    {
        ...
        If (LGreaterEqual (Arg0, 0x03))
        {
            ...
            {
                Store (Zero, \_SB.PCI0.LPCB.EC.NVRB)
                Store (Zero, \_SB.PCI0.LPCB.EC.NVOK)
            }
        }

        Store (One, \_SB.PCI0.LPCB.EC.S3ST)
        If (LEqual (Arg0, 0x03))
        {
            Store (Zero, \_SB.PCI0.LPCB.EC.S3ST)
        }
        ...
        If (LEqual (Arg0, 0x03))
        {
            If (\_SB.PCI0.LPCB.EC.ECOK)
            {
                Store (\_SB.PCI0.LPCB.EC.ADP, ACDC)
            }
            ...
            Method (WMBB, 3, Serialized)
            {
                ...
                If (LEqual (ToInteger (Arg1), 0x13))
                {
                    If (^^PCI0.LPCB.EC.ECOK)
                    {
                        If (LEqual (ARGS, One))
                        {
                            Or (^^PCI0.LPCB.EC.AMOD, One, ^^PCI0.LPCB.EC.AMOD)
                        }
                        Else
                        {
                            And (^^PCI0.LPCB.EC.AMOD, Zero, ^^PCI0.LPCB.EC.AMOD)
                        }
                    }
                ...
                If (LEqual (ToInteger (Arg1), 0x52))
                {
                    ...
                    Store (0xBB, ^^PCI0.LPCB.EC.FCMD)
                    If (LEqual (^^PCI0.LPCB.EC.FBUF, 0x02))
                    {
